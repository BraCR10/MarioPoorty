 ...
 */
public class ThreadExplosionAnimation extends Thread{
   private  boolean isRunning = true;
    ...
    public ThreadExplosionAnimation(BomberMarioScreen screen, int sourceX, int sourceY, Point[] chestPositions, int explotionType) {
        this.screen=screen;
        ...
        while (isRunning) {       
            ...
            if(screen.getSettings().getChestFoundPartCounter()>4){
               ...
               try {
                    ...
                    Logger.getLogger(ThreadExplosionAnimation.class.getName()).log(Level.SEVERE, null, ex);
                }
