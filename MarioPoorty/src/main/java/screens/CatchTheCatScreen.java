...
import minigames.SpriteAreaSelector;
...
public class CatchTheCatScreen extends JFrame implements IScreenMethods{
    ...
    private final int characterCentreAdjust = 15;
    ...
    public void putCharacter(int x, int y) {
        ...
        characterLabel.setBounds(x*xOFFSET+ characterCentreAdjust, (y*yOFFSET- characterCentreAdjust), characterLabel.getPreferredSize().width, characterLabel.getPreferredSize().height);
        jpPlayGround.revalidate();
        jpPlayGround.repaint();
    }
